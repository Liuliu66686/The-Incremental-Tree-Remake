var systemComponents = {
    ...
    'info-tab': {
        ...
        <br>
        模组树 <a v-bind:href="'https://github.com/Acamaeda/The-Modding-Tree/blob/master/changelog.md'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >{{TMT_VERSION.tmtNum}}</a> 制作者 Acamaeda
        <br>
        声望树原版制作者 Jacorb 和 Aarex
		<br>
		模组树制作模版制作者 辉影神秘
		<br><br>
    ...
    'options-tab': {
        ...
        <table>
            <tr>
                ...
                <td><button class="opt" onclick="hardReset()">硬 重 置</button></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><button class="opt" onclick="toggleOpt('hideChallenges')">已完成挑战显示: {{ options.hideChallenges?"隐藏":"显示" }}</button></td>
                <td><button class="opt" onclick="toggleOpt('forceOneTab'); needsCanvasUpdate = true">单标签页显示: {{ options.forceOneTab?"总是":"自动" }}</button></td>
				</tr> 
        </table>`
    },
